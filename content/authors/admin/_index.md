...
interests:
  ...
  - Epistemology of Causal Inference
  - Causal Cognition
education:
...
social:
  - icon: envelope
    icon_pack: fas
    link: "mailto:thomas.blanchard@u-bordeaux-montaigne.fr"
  - icon: graduation-cap
    icon_pack: fas
    link: https://philpeople.org/profiles/thomas-blanchard
  - icon: archive
    icon_pack: fas
    link: http://philsci-archive.pitt.edu/view/creators/Blanchard=3AThomas=3A=3A.html
superuser: true
---
